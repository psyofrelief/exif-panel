...
export default function SwatchesIcon({ className }: { className?: string }) {
  return (
    <svg
      version="1.1"
      id="Capa_1"
      ...
      xmlSpace="preserve"
      className={cn(
        "w-5 h-auto stroke-2 p-px fill-popover-foreground stroke-popover-foreground",
        className
      )}
    >
      <path
        d="M294.081,72.683L224.316,2.918c-3.891-3.889-10.2-3.891-14.095,0l-23.256,23.255c-1.869,1.869-2.919,4.404-2.919,7.047
